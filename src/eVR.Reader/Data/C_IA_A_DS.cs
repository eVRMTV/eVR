...
{
    /// <summary>
    /// This class contains the content of file EF C.IA_A.DS on the card.
    /// 
    /// EF C.IA_A.DS contains the DS certificate used to set the signature 
    /// EF Signature_A over the data in EF Registration_A. 
    /// </summary>
    ...
    public class C_IA_A_DS
        : IElementaryFile
    {
        #region Properties
        
        public string Name => "CIA A DS";
        public byte[] Identifier => new byte[] { 0xC0, 0x01 };
